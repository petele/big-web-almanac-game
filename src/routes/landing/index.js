...
export default class Landing extends Component {
  ...
  render() {
    document.title = 'The Big Web Almanac Quiz';
    ...
    return (
      <div class="container">
        <h1>Welcome to the Big Web Almanac Quiz{chapterName ? <span>: <strong class="edition">{chapterName} edition</strong></span> : ''}!</h1>
